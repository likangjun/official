                            ...
                            <div id="post-3888"
                                ...
                                <div class="inner">
                                    ...
                                    <div class="post-posts-links clearfix">
                                        <?php if ($prev) { ?>
                                            <div class="left">
                                                <a href="index.php?r=process/detail&id=<?= $prev['id'] ?>" rel="prev">Prev</a>
                                            </div>
                                        <?php } ?>
                                        <?php if ($next) { ?>
                                            <div class="right">
                                                <a href="index.php?r=process/detail&id=<?= $next['id'] ?>" rel="next">Next</a>
                                            </div>
                                        <?php } ?>
                                    ...
                                    <div class="post-related-posts">
                                        ...
                                        <?php foreach ($related as $v) { ?>
                                            <div class="related-element without-image">
                                                <a href="index.php?r=process/detail&id=<?= $v['id'] ?>"></a>
                                                <div class="related-element-info">
                                                    <a style="display: -webkit-box;height: 41px;" href="index.php?r=process/detail&id=<?= $v['id'] ?>"><?= $v['title'] ?></a>
                                                    <div class="date">
